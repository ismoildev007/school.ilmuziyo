                ...
                <form action="{{ route('about.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="sciences_uz"
                               placeholder="Chuqurlashtirilgan fanlarni kiriting uzbek" value="{{ old('sciences_uz') }}"/>
                        @error('sciences_uz')
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="sciences_ru"
                               placeholder="Chuqurlashtirilgan fanlarni kiriting rus" value="{{ old('sciences_ru') }}"/>
                        @error('sciences_ru')
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="sciences_en"
                               placeholder="Chuqurlashtirilgan fanlarni kiriting english" value="{{ old('sciences_en') }}"/>
                        @error('sciences_en')
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="language_uz"
                               placeholder="boshlang'ich sinfda qaysi tillar uz" value="{{ old('language_uz') }}"/>
                        @error('language_uz')
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="language_ru"
                               placeholder="boshlang'ich sinfda qaysi tillar ru" value="{{ old('language_ru') }}"/>
                        @error('language_ru')
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="language_en"
                               placeholder="boshlang'ich sinfda qaysi tillar en" value="{{ old('language_en') }}"/>
                        @error('language_en')
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="big_language_uz"
                               placeholder="Yuqori sinfda qaysi tillar uz" value="{{ old('big_language_uz') }}"/>
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="big_language_ru"
                               placeholder="Yuqori sinfda qaysi tillar ru" value="{{ old('big_language_ru') }}"/>
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="big_language_en"
                               placeholder="Yuqori sinfda qaysi tillar en" value="{{ old('big_language_en') }}"/>
